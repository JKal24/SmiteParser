...
public class DuelControllerData implements GameModeData {
    @Id
    ...
    public DuelControllerData() { }

    public DuelControllerData(Integer id, String leaves, String losses, String name, String points, String prevRank,
