...
public class ConquestControllerInfo implements GameModeData {
    @Id
    ...
    public ConquestControllerInfo() { }

    public ConquestControllerInfo(Integer id, String leaves, String losses, String name, String points, String prevRank,
